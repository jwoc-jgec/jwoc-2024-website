...
function RegistrationButton({ title, link }: { title: string; link: string }) {
  return (
    <Link
      href={`register/${link}`}
      className="relative w-80 md:w-[35rem] flex items-center justify-center drop-shadow-cyanGlow py-3 px-10 md:py-5 md:px-28 text-cyan-300 bg-cyan-300 bg-opacity-10 font-bold text-lg md:text-2xl ring-2 ring-cyan-300"
    >
...
function page() {
  return (
    <div className="flex justify-center items-center flex-col h-[90vh] gap-y-14 text-white">
      ...
      <div className="flex justify-center items-center flex-col gap-y-5 p-6 rounded-lg bg-violet-950">

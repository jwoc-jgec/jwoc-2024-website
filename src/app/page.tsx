            ...
            <div className="flex font-black text-center md:text-start flex-col text-[#00FFFF]">
              <div className="pb-6">
                ...
                <motion.h1
                  ...
                  className="text-[6vh] silk text-transparent bg-clip-text bg-gradient-to-r from-[#FB7185] via-[#D9EFFF] to-[#6366F1] md:text-7xl"
              ...
              >
                JWoC (JGEC Winter of Code) is a coding event organised annually
                by JGEC which helps students to plunge into Open Source
                contribution and get the realm of Software Development.
              </motion.p>
              <motion.div
                initial={{ opacity: 0, x: -200 }}
                animate={{ opacity: 1, x: 0 }}
